...
from jmetal.util.archive_omopso import BoundedArchive, NonDominatedSolutionListArchive
from jmetal.util.get_solution import get_reference_front
...
class OMOPSO(ParticleSwarmOptimization):
    ...
    def igd_calculate(self):
        ...
        # 计算当前IGD
        result = InvertedGenerationalDistance(front_objectives).compute(self.get_result())
        return result
